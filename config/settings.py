...
EMAIL_BACKEND = my_settings.EMAIL_BACKEND  # 메일을 보내는 방식
EMAIL_HOST = my_settings.EMAIL_HOST  # 메일을 호스트 하는 서버
EMAIL_PORT = 587  # 메일과 통신하는 포트
EMAIL_USE_TLS = True  # TLS 보안 사용
EMAIL_HOST_USER = my_settings.EMAIL_HOST_USER  # 발신할 네이버 이메일
EMAIL_HOST_PASSWORD = my_settings.EMAIL_HOST_PASSWORD  # 네이버 앱 비밀번호
